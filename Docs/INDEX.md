...
| `Docs/Systems/Save.md` | versioned save framing, validation, integrity, migration, I/O, and recovery ownership | when changing persistence or reviewing BS-020 and later Save tasks |
