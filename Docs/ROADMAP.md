...
**Current M2 status:** BS-014 and corrective task BS-014A are Done on `main`; BS-015 automated verification is complete and creator verification is pending on `feature/BS-015-core-observability`.
