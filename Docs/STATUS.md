...
- Active task: `BS-010` — first Automation smoke test and canonical English migration.
...
- BS-010 preliminary working-tree verification after Generate: `Tools/BS.cmd Test` performed 1 test, 1 succeeded, 0 failed; candidate evidence is still pending.
